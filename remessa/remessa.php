...
Class RemessaSicredi{
	...
	public function __construct($SetSacados){
		...
		$this->titulo.= '756'; 
		// 15 carácter - 'Sicoob'= 07 e Brancos = 08
		$this->titulo.= 'SICOOB'.self::PreencherCaracteres('8','vazio'); 
	...
	private function GerarArquivo($SetConteudo){
		if(date('m') == '10'){
			...
			$this->codMes = substr(date('md'), 1);
                ...
                // permissão 777 na pasta onde vai gerar o arquivo
		$this->NomeArquivo = $this->codCedente.$this->codMes.'.txt'; 
...
$GetTitulo[] = array('129','10/04/2021','2,00','03829504969','JOAO GALINO','R. JORGIOR DE ARMANI, 172','86083310');
$GetTitulo[] = array('139','11/04/2021','3,00','03829504969','MARIA SILVA','R. JORGIOR DE ARMANI, 145','86083310');
$GetTitulo[] = array('149','12/04/2021','4,00','20105220000197','ZÉ ABREU','R. JORGIOR DE ARMANI, 167','86083310');
